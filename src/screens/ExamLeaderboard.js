...
const ExamLeaderboard = ({ navigation }) => {
    ...
    const series = [70, 30];
    const sliceColor = ['#6A5AE0', '#ff9100'];
    ...
    return (
        <SafeAreaView  >
            ...
            <ScrollView showsVerticalScrollIndicator={false} >
                ...
                <View style={{ height: responsiveHeight(32), alignSelf: 'center', paddingHorizontal: 10, width: responsiveWidth(90), marginBottom: 10, backgroundColor: '#fff', marginTop: 10, borderRadius: 8, elevation: 10 }}>
