...
const Policy = ({ navigation }) => {
  ...
  const Api = async () => {
    try {
      ...
      fetch(`${base_url}/privacy-policy`, requestOptions)
    ...
    <SafeAreaView>
      <View style={{ height: responsiveHeight(7), width: responsiveWidth(100), justifyContent: 'center', backgroundColor: '#6A5AE0', paddingHorizontal: 20 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'flex-start' }}>
          ...
          <Text style={{ color: '#fff', fontSize: 18, fontWeight: '500', alignSelf: 'center', marginTop: 10, marginLeft: '5%' }}>Privacy Policy</Text>
        </View>
      </View>
